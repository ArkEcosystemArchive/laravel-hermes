    ...
    <div class="relative w-11 h-11">
        ...
        >
            <div class="flex flex-shrink-0 items-center justify-center rounded-full {{ $stateColor }} h-7 w-7">
                @if ($type === ARKEcosystem\Hermes\Enums\NotificationFilterEnum::DANGER)
                ...
                @elseif ($type === ARKEcosystem\Hermes\Enums\NotificationFilterEnum::SUCCESS)
                    <div class="flex items-center justify-center flex-shrink-0 w-6 h-6 rounded-full bg-theme-success-100">
                        <x-ark-icon name="notifications.success" size="xs" class="text-theme-success-600" />
                    </div>
                @elseif ($type === ARKEcosystem\Hermes\Enums\NotificationFilterEnum::WARNING)
                    <div class="flex items-center justify-center flex-shrink-0 w-6 h-6 rounded-full bg-theme-warning-100">
                        <x-ark-icon name="notifications.warning" size="xs" class="text-theme-warning-600" />
                    </div>
                @elseif ($type === ARKEcosystem\Hermes\Enums\NotificationFilterEnum::BLOCKED)
                    <div class="flex items-center justify-center flex-shrink-0 w-6 h-6 rounded-full bg-theme-secondary-200">
                        <x-ark-icon name="notifications.blocked" size="xs" class="text-theme-secondary-900" />
                    </div>
                @elseif ($type === ARKEcosystem\Hermes\Enums\NotificationFilterEnum::COMMENT)
                    <div class="flex items-center justify-center flex-shrink-0 w-6 h-6 rounded-full bg-theme-secondary-200">
                        <x-ark-icon name="notifications.comment" size="xs" class="text-theme-secondary-900" />
                    </div>
                @elseif ($type === ARKEcosystem\Hermes\Enums\NotificationFilterEnum::MENTION)
                    <div class="flex items-center justify-center flex-shrink-0 w-6 h-6 rounded-full bg-theme-secondary-200">
